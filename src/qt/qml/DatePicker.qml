                    ...
                    states: [
                        State {
                            ...
                            PropertyChanges {
                                ...
                                visible: true
                                source: MMPTheme.themeSelect("qrc:/res/icons/calendar/ic_date_start_background_light.svg","res/icons/calendar/ic_date_start_background_dark.svg")
                            }
                        ...
                        State {
                            ...
                            PropertyChanges {
                                target: dateBackgroundImg
                                visible: true
                                source: MMPTheme.themeSelect("qrc:/res/icons/calendar/ic_date_end_background_light.svg","res/icons/calendar/ic_date_end_background_dark.svg")
                            }
                            PropertyChanges { target: dateText; color: MMPTheme.cWhite }
                            PropertyChanges {
                ...
                navigationBar: Item {
                    ...
                    MouseArea {
                        ...
                        Rectangle {
                            ...
                            Image {
                                id: leftArrowImg
                                source: MMPTheme.themeSelect("qrc:/res/icons/generic/ic_chevron_left_light.svg","res/icons/generic/ic_chevron_left_dark.svg")
                    ...
                    MouseArea {
                        ...
                        Rectangle {
                            ...
                            Image {
                                id: rightArrowImg
                                source: MMPTheme.themeSelect("qrc:/res/icons/generic/ic_chevron_right_light.svg","qrc:/res/icons/generic/ic_chevron_right_dark.svg")
                                sourceSize: Qt.size(20, 20)
                                anchors.centerIn: parent
                            }
                        }
