// Window allowing the user to vote on a poll
import QtQuick 2.15
...
Window {
    ...
    Rectangle {
        ...
        Button {
            id: submitVoteButton
            icon.source: MMPTheme.themeSelect("qrc:/res/icons/buttons/ic_btn_vote_light.svg", "qrc:/res/icons/buttons/ic_btn_vote_dark.svg")
            text: qsTr("Vote")
            enabled: {
