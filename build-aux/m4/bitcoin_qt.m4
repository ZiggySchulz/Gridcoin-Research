...
AC_DEFUN([_BITCOIN_QT_CHECK_STATIC_LIBS], [
  ...
  PKG_CHECK_MODULES([QT_QUICKCONTROLS2], [${qt_lib_prefix}QuickControls2${qt_lib_suffix}], [QT_LIBS="$QT_QUICKCONTROLS2_LIBS $QT_LIBS"])
  dnl Gridcoin uses SVG:
...
AC_DEFUN([_BITCOIN_QT_FIND_LIBS],[
  ...
  BITCOIN_QT_CHECK([
    PKG_CHECK_MODULES([QT_QUICKCONTROLS2], [${qt_lib_prefix}QuickControls2${qt_lib_suffix} $qt_version], [QT_INCLUDES="$QT_QUICKCONTROLS2_CFLAGS $QT_INCLUDES" QT_LIBS="$QT_QUICKCONTROLS2_LIBS $QT_LIBS"],
